...
- `Stirring` is a runner food-run where player reaches the end of a running trail
...
- 3-minute runner segment, then return to kitchen flow
...
### Stirring
- `E` to start station
- Complete runner trail and reach the end goal
...
- Collect required ingredients only
